...
// Si requête POST, traiter avant tout output (redirections headers-safe)
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Insertion en base de données et envoi du mail
    try {
        $pdo = new Database();
        ...
        if ($user) {
            ...
            // Envoi silencieux : capture d'erreurs si nécessaire
            try {
                $mail->send();
            } catch (Exception $e) {
