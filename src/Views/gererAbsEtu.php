...
<table class="liste-absences"> 
    ...
    <tr>
        ...
        <td>
            <?php if ($enRevision): ?>
                <span class="statut-revision">En révision</span>
            <?php else: ?>
        ...
        <td>
            ...
            ?>
                <a href="etudiant/depotJustificatif.php?id=<?php echo $idAbsence; ?>&date_start=<?php echo $dateDebut; ?>&date_end=<?php echo $dateFin; ?>&motif=<?php echo $motifUrl; ?>&ressoumission=1" class="btn-resoumettre">Resoumettre un justificatif</a>
            <?php else: ?>
