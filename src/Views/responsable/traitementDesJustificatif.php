...
// ID reçu depuis gestionAbsence.php
...
<div class="text fade-in">
            ...
            <div id="zone-raison-refus">
                ...
                <div class="radio-group">
                    <label>
                        ...
                        <div>
                            <strong>Refus définitif</strong><br>
                            <span>L'étudiant ne pourra pas resoumettre cette absence</span>
                        </div>
                    </label>
                    <label>
                        <input type="radio" name="type_refus" value="ressoumission">
                        <div>
                            <strong>Refus avec possibilité de ressoumission</strong><br>
                            <span>L'étudiant pourra modifier et resoumettre son justificatif</span>
                        </div>
                    </label>
                </div>
    ...
    <?php if (isset($_GET['demande']) && $_GET['demande'] === 'true' && $absence): ?>
        <div class="zone-demande-justif">
            ...
            <div class="info-etudiant">
                <p>
                    <strong>Étudiant :</strong> <?php echo htmlspecialchars(($absence['prenomcompte'] ?? '') . ' ' . ($absence['nomcompte'] ?? '')); ?>
                </p>
                <p>
    ...
    <?php if (isset($_GET['email_sent']) && $_GET['email_sent'] === 'true' && $absence): ?>
        <div class="message-succes">
            ...
            <div class="actions">
                <a href="gestionAbsence.php" class="btn-retour">
